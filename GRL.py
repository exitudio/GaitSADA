...
def get_parser():
    ...
    parser.add_argument('--log_dir', default="logs/Baselines/AMCA_DomClas_GRL_VANILLA_REMOVE_AM/")
    parser.add_argument('--disc_hidden', type=int, default=128)
    parser.add_argument('--notes', default="AMCA_STDomClas_GRL_Baseline_remove_AM")
    return parser
...
def write_acc(test_set, y_test):
    ...
    with open(os.path.join(path_acc, "GRL"), 'a') as f:
